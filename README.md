...
<div align="center">
    <img src="https://media.tenor.com/g7gjdXHvZ5UAAAAd/wakfu-nox.gif" width="500px">
</div>
...
```zsh
Suro : A funny dev from France
```

<img align="left" src="https://cdnb.artstation.com/p/assets/images/images/031/799/631/original/yuriy-horgon-pos1.gif?1604614666" width="279px"/>

```csharp
My Profile ver. 5.0.1: クルシュ・カルステンは、美と戦いを一体化させるヴァルキリーである.「クルシュ・カルステンは、びとたたかいをいったいかさせるヴァルキリーである」
----------------------------------------------------------------------------------------
Username: Suro「棕櫚す」
WhoamI: Student in Computer Science.
Fav.Anime(1):  (Dragon Ball Z) 🐉
Fav.Anime(2): からかい上手の高木さん (Jujutsu Kaisen) 👹
Pronouns: He/Him
Languages: PHP , SQL, Js , Git, Python
Frameworks: Laravel, HonoJS, Inertia
Hobbies: (🎾Tennis, 🎮 Video Games, 🎲 Board Games)
Learning: Python
My GOAL ?: Become AI and Data Engineer 
Languages.Native: French
Languages.(C1/C2): English
```
</div>
<br>
<br>
